                        ...
                        <li>
                            <a href="#"
                               className="flex justify-between items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                                <span className="flex whitespace-nowrap">Inbox</span>
                                <span
                ...
                <div className="absolute space-y-2 bottom-0 w-60">
                    <a type="button"
                       ...
                       className="flex justify-between items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                        ...
                        <span
                            className="inline-flex items-center w-7 h-7 p-2 ml-3 text-sm font-medium bg-black rounded-full">
                    ...
                    <a type="button"
                       ...
                       className="flex justify-between items-center p-2 text-white rounded-lg bg-black cursor-pointer hover:bg-gray-900 group">
                        ...
                        <span
                            className="inline-flex items-center w-7 h-7 p-2 ml-3 text-sm  font-medium rounded-full">...</span>
                        {
                            userBtn && <>
                                <div
